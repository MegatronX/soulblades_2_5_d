...
public partial class ModifyStat_EffectLogic : EffectLogic
{
    ...
    [Export]
    public StatModType ModificationType { get; private set; }
    ...
    {
        var statsComponent = target.GetNode<StatsComponent>("StatsComponent");
        if (statsComponent == null) return;

        // 'this' is the source of the modifier, ensuring we can remove it later.
        var modifier = new StatModifier(Value, ModificationType, this);
